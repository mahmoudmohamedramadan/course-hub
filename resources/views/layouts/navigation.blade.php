        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center rounded-md border border-transparent bg-white/0 px-3 py-2 text-sm font-medium leading-4 text-slate-600 hover:text-slate-900 focus:outline-none transition ease-in-out duration-150 dark:text-slate-300 dark:hover:text-white">
            ...
            @else
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3 text-sm font-medium">
                <a href="{{ route('login') }}"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-slate-200 dark:border-slate-800">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-slate-600 dark:text-slate-300">{{ Auth::user()->email }}</div>
            </div>
